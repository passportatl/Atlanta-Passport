// AUTO-GENERATED from the "Atlanta Passport" Google Sheet (BUSINESS tab).
  // Authoritative business-page content sourced from the partner sheet: tagline
  // (-> description), about, passport offer, hours, and address. Applied as an
  // override layer over the curated entries in sample-data.ts (curated fields like
  // lat/lng, image, transit, sponsorTier, categories, structured menu are kept).
  // Light cleanup only (obvious typos, casing, dash normalization); content is the
  // partner's own. To refresh: re-run the sheet import; do not hand-edit rows here.

  export interface BusinessSheetOverride {
    description?: string;
    about?: string;
    offer?: string;
    hours?: string;
  ...
  export const BUSINESS_SHEET_DATA: Record<string, BusinessSheetOverride> = {
    "adair-park-i": {
  ...
  "asw-distillery": {
    hours: "Wed-Thurs 11am-6pm (retail only), Fri (retail) 11am-3pm (tours)3pm-8pm, Sat 1pm-6pm, Sun 2pm-6pm",
  ...
  "atlantucky-brewing": {
    ...
    offer: "10% off",
    hours: "Wed-Fri 3pm-12am, Sat 12pm-12am, Sun 12pm-9pm, EVERY HOME GAME DAY 12pm-12am",
  ...
  "chick-fil-a": {
    description: "A famous fast food chain of the south.",
    address: "400 Bill Kennedy Way SE",
  },
  "clark-atlanta-university-harkness-hall-area": {
  ...
  "felixs-atlanta": {
    description: "Karaoke & drag shows weekly, cocktails, friendly & community-driven.",
    address: "1510-G Piedmont Ave NE",
  },
  "freedom-park": {
  ...
  "grant-park": {
    description: "One of Atlanta’s oldest & largest parks, known for mature trees, historic landscapes, walking paths, Zoo Atlanta and surrounding Victorian architecture.",
  ...
  "hammonds-house-museum": {
    description: "African-diaspora art",
  ...
  "liddel-house": {
    description: "Atlanta's second-oldest house.",
    address: "464 Montgomery Ferry Rd NE",
  },
  "lindbergh-station": {
  ...
  "midtown-bowl": {
    description: "32 bowling lanes, walk-ins available, 21+ after 9pm",
    address: "1836 Piedmont Cir NE",
  },
  "mlk-mural-at-trap-city-cafe": {
    description: "\"Injustice anywhere is a threat to justice everywhere.\"",
    about: "This powerful mural honors the legacy of Dr. Martin Luther King Jr. and carries one of his most enduring messages. Affirmations Acrooss America is a nonprofit initiative about painting positive affirmation murals across America starting with Atlanta. Affiliated with B Aware Foundatioon and A-town Art Agency. Muralist by bornartistofficial on IG.",
    address: "660 Northside Dr NW Atlanta, GA 30318",
  },
  "morehouse-college-campus-landmark": {
  ...
  "oakland-cemetery": {
    ...
    address: "248 Oakland Ave SE Visitor parking 342 Martin Luther King Jr. Dr SE",
  },
  "orme-park": {
  ...
  "peachtree-wellness": {
    offer: "15% OFF Crystals, $4 5mg THC Spicy Cucumber Kiwi Margarita",
    hours: "Mon-Thurs 11am-8pm, Fri-Sat 11am-9pm, Sun 11am-6pm",
    address: "585 Memorial Dr SE",
  },
  "perkerson-park": {
  ...
  "six-feet-under": {
    description: "Casual seafood restaurant and pub serving lunch & dinner",
    address: "1824 Cheshire Bridge Rd NE",
  },
  "smiths-old-bar": {
    description: "Historic bar with pool, darts, and live-music venue.",
    address: "1578 Piedmont Ave NE",
  },
  "spelman-college-museum-of-fine-art": {
    description: "Black woman's art and HBCU heritage.",
  ...
  "tattletale-lounge": {
    hours: "Mon-Sat 12pm-3am, CLOSED SUNDAY",
    address: "2075 Piedmmont Rd",
  },
  "the-belthub": {
    address: "1385 English St NE Bldg A, Unit A",
  },
  "the-painted-pickle": {
    about: "32,500 square foot indoor/outdoor “ with 9 pickleball courts, , patios, cocktails, food, ping pong, darts, & more.",
    hours: "Mon-Thurs 9am (courts) 11am (food & drink) - 10pm, Fri-Sat 9am (courts) 11am (food & drink) - 12am. Fri & Sat 21+ AFTER 9PM.",
    address: "279 Ottley Dr NE",
  },
  "the-westwood": {
    description: "Affordable & delicious drinks, solid comfort food with options for late-night dining, pool, and darts!",
    offer: "$2 Westwood's World Famous Cheerwine Jello Shots",
    hours: "Sun-Thurs 12pm-12am Fri-Sat 12pm-2am",
    address: "1529 Ralph David Abernathy Blvd SW",
  },
  "the-wrens-nest": {
  ...
  "tiny-door-atl-26": {
    description: "Miniature-art photo stop.",
    address: "630 Travis St NW",
  },
  "tongue-and-groove": {
    hours: "ed-Sat 9pm-2:30am",
  ...
  "vickerys-bar-grill": {
    ...
    about: "Vickery’s Bar & Grill opened its doors in 1983 and instantly became an Atlanta institution, known for great food, a lively atmosphere, and friendly bar. That tradition continues just off the Beltline at Vickery's Glenwood Park. Lunch or dinner, late night drinks or Weekend Brunch, Vickery's offers a coastal Southern Cuisine featuring Fried Green Tomatoes, Catfish and Grits, Low Country Seafood Sautee and classic Southern Fried Chicken. Weekend Brunch favorites include Crab Cake Egg Benedict, Pancakes, Lox & Bagel, Egg Platters and our potent champagne cocktails and spicy Bloody Marys. We have something for everyone, anytime.",
    offer: "FREE DESSERT WITH EACH ENTREE PURCHASE DINE IN ONLY. OFFER VALID THROUGH JULY 31 2026",
    hours: "DINING ROOM: MONDAY 5:00-11:00 TUESDAY-FRIDAY 11:30-11:00 SATURDAY & SUNDAY 11:00-11:00 BAR: SUNDAY-TUESDAY UNTIL MIDNIGHT WEDNESDAY-SATURDAY UNTIL 2:00",
    address: "933 Garrett St #101 Atlanta, GA 30316",
  },
  "waffle-house": {
    description: "An iconic Atlanta-founded diner, breakfast food all day.",
    about: "Open 24/7",
    address: "860 Glenwood Ave SE",
  },
  "washington-park": {
  ...
  "wheelhaus-bikes": {
    ...
    address: "1188 Glenwood Ave SE Suit B",
  },
  "zoo-atlanta": {
    hours: "Sun-Thurs 9am-5pm (last entry 3pm), Fri-Sat 9am-6pm (last entry 4:30)",
