...
import vickerysImg from "@/assets/images/vickerys-featured.jpg";
...
const businessesRaw = [
  {
    ...
    category: "Drink",
    categories: ["Drink", "Food", "Experiences"],
    visitMinutes: 75,
    ...
    offer: "10% off your tab when you get your Atlanta Passport stamped.",
  ...
  },
  {
    ...
    offer: "$2 Westwood's World Famous Cheerwine Jello Shots when you get your Atlanta Passport stamped.",
  ...
  },
  {
    ...
    offer: "10% off admission when you get your Atlanta Passport stamped.",
  ...
  },
  {
    ...
    categories: ["Food", "Drink"],
    neighborhood: "Glenwood Park",
    description: "A famous fast-food chain born in the South.",
    address: "400 Bill Kennedy Way SE, Atlanta, GA 30316",
    lat: 33.7386,
    lng: -84.3612,
  },
  {
    ...
    neighborhood: "Piedmont Heights",
    description: "Karaoke & drag shows weekly, cocktails, friendly and community-driven.",
    address: "1510-G Piedmont Ave NE, Atlanta, GA 30324",
    lat: 33.79661,
    lng: -84.36958,
  },
  {
    ...
    address: "464 Montgomery Ferry Rd NE, Atlanta, GA 30309",
    lat: 33.7965,
    lng: -84.376,
    about: "Atlanta's second-oldest house.",
  },
  {
    id: "midtown-bowl",
    ...
    address: "1836 Piedmont Cir NE, Atlanta, GA 30324",
    lat: 33.80851,
    lng: -84.3665,
  },
  {
  ...
  },
  {
    ...
    neighborhood: "Piedmont Heights",
    description: "Historic bar with pool, darts, and a live-music venue.",
  ...
  },
  {
    ...
    categories: ["Games", "Food", "Drink"],
    neighborhood: "Buckhead",
    description: "A 32,500-square-foot indoor/outdoor venue with 9 pickleball courts, patios, cocktails, food, ping pong, darts, and more.",
    ...
    website: "https://paintedpickle.com/",
    about: "A 32,500-square-foot indoor/outdoor venue with 9 pickleball courts, patios, cocktails, food, ping pong, darts, and more.",
  },
  {
    id: "waffle-house",
    ...
    neighborhood: "Glenwood Park",
    description: "An iconic Atlanta-founded diner serving breakfast food all day.",
    address: "860 Glenwood Ave SE, Atlanta, GA 30316",
    lat: 33.74002,
    lng: -84.35972,
    hours: "Open 24/7",
  },
  {
    ...
    neighborhood: "Grant Park",
    description: "A beloved Grant Park institution and one of the country's oldest zoos.",
    address: "800 Cherokee Ave SE, Atlanta, GA 30315",
    lat: 33.73279,
    lng: -84.37373,
    hours: "Sun-Thurs 9am-5pm (last entry 3pm), Fri-Sat 9am-6pm (last entry 4:30pm)",
  },
  {
    id: "asw-distillery",
    ...
    neighborhood: "Buckhead",
    description: "An Atlanta craft distillery with a retail bottle shop, tastings, and guided tours.",
    address: "199 Armour Dr NE, Atlanta, GA 30324",
    lat: 33.80937,
    lng: -84.38206,
    hours: "Wed-Thurs 11am-6pm (retail only), Fri 11am-3pm (retail) / 3pm-8pm (tours), Sat 1pm-6pm, Sun 2pm-6pm",
  ...
  },
  {
    ...
    neighborhood: "Buckhead",
    description: "A long-running late-night Atlanta lounge.",
    address: "2075 Piedmont Rd NE, Atlanta, GA 30324",
    lat: 33.81185,
    lng: -84.3664,
    hours: "Mon-Sat 12pm-3am, closed Sunday",
    website: "https://www.tattletalelounge.com/",
  },
  {
    ...
    neighborhood: "Buckhead",
    description: "A Lindbergh nightlife staple for dancing, DJs, and late-night events.",
    address: "565 Main St NE, Atlanta, GA 30324",
    lat: 33.8235,
    lng: -84.3697,
    hours: "Wed-Sat 9pm-2:30am",
    website: "https://tandgonline.com/",
  },
  {
    ...
    category: "Landmarks",
    neighborhood: "Buckhead",
    description: "A major MARTA rail station and transit hub in Buckhead — a convenient starting point for exploring the city car-free.",
...
export const events = [
  ...
  {
    id: "castleberry-hill-artist-market",
    name: "Castleberry Hill Artist Market",
    date: "June 12, 2026",
    time: "7pm – 10pm",
    venue: "172 Haynes St SW",
    address: "172 Haynes St SW, Atlanta, GA 30313",
    neighborhood: "Castleberry Hill",
    category: "Market",
    price: "Free",
    description: "",
  ...
  },
  {
    ...
    name: "Fizz Ed Ft. Creature Comforts",
    date: "June 18, 2026",
    time: "6pm",
    venue: "BoxCar at Hop City",
    address: "1001 White St SW, Atlanta, GA 30310",
    neighborhood: "West End",
    category: "Tasting",
    price: "$",
    ticketPrice: "$15",
  ...
  },
  {
    ...
    name: "West Coast Classics Wine Tasting",
    date: "June 25, 2026",
    time: "6pm",
    venue: "BoxCar at Hop City",
